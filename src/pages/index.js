...
<html>
	<head>
		...
		<meta charSet="utf-8"/>
		<meta name="description" content="We are a Singapore online gift shop offering unique gifts for various occasions."/>
		<meta property="og:title" content="Eileen Town Gift Shop Singapore"/>
		<meta property="og:description" content="We are a Singapore online gift shop offering unique gifts for various occasions."/>
		<meta property="og:updated_time" content="1637253708000"/>
		<meta property="profile:username" content="eileentown"/>
		<meta name="twitter:title" content="Eileen Town Gift Shop Singapore"/>
		<meta name="twitter:description" content="We are a Singapore online gift shop offering unique gifts for various occasions."/>
		...
		<meta property="og:site_name" content="Eileen Town Gift Shop Singapore"/>
		<meta property="og:type" content="profile"/>
		<meta content="2419200"/>
		<meta name="twitter:card" content="summary_large_image"/>
		<meta name="twitter:domain" content="eileentownsg"/>
		<meta name="theme-color" content="#ffffff"/>
		<meta name="theme-color" content="#ffffff"/>
		<title>Eileen Town Gift Shop Singapore</title>
		<meta name="next-head-count" content="9"/>
		<style data-styled="" data-styled-version="5.2.1">.fGhsIW{-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;position:relative;padding-bottom:0;min-height:100vh;overflow-x:hidden;width:100%;height:100%;}/*!sc*/
...
.hqcxUx{position:relative;height:auto;style-type:fill;border-type:squared;}/*!sc*/
...
.dxWfkp{height:20px;}/*!sc*/
data-styled.g1[id="sc-bdfBwQ"]{content:"fGhsIW,bcrzgk,LyLIy,jbINSs,eZNKTD,jgGrsq,llgrqs,hTuoxC,pkAuV,hqcxUx,kMVUFR,cUWRuD,ihnwqk,dkrNTA,bnzAjP,jAmcnV,gchjEV,eKvZIH,kxNToM,hVYfjR,iOGite,fKOsqo,gNTMHV,VVPDD,dxWfkp,"}/*!sc*/
...
.cTsoyo{margin:0;color:palette.slate13;font-weight:700;font-size:16px;line-height:1.5;text-overflow:ellipsis;max-width:100%;white-space:nowrap;overflow:hidden;}/*!sc*/
...
data-styled.g3[id="sc-dlfnbm"]{content:"cTsoyo,kwNybW,"}/*!sc*/
.lloOXm{padding:0;margin:0;text-align:center;line-height:1.5;font-size:14px;color:palette.slate13;}/*!sc*/
...
data-styled.g4[id="sc-hKgILt"]{content:"lloOXm,kVCYxL,hyPPpq,cwiWLN,"}/*!sc*/
...
data-styled.g5[id="sc-eCssSg"]{content:"gsOJfM,kZodAG,"}/*!sc*/
.dzFiqz{fill:currentColor;width:lg;height:lg;fill:#39e09b;width:32px;height:32px;}/*!sc*/
...
data-styled.g7[id="sc-gKsewC"]{content:"dzFiqz,gAHPqj,iSHMGE,eaSLVe,"}/*!sc*/
...
.hdlZPy:hover{background-color:transparent;color:#39e09b;border-color:#39e09b;}/*!sc*/
data-styled.g97[id="StyledContainer__StyledLinkContainer-sc-1kae6sc-0"]{content:"hdlZPy,"}/*!sc*/
...
data-styled.g110[id="Button__StyledText-sc-uh5tyw-0"]{content:"rsIfq,"}/*!sc*/
.bAHUYV{opacity:0;-webkit-transition:opacity 500ms ease-in-out;transition:opacity 500ms ease-in-out;}/*!sc*/
data-styled.g153[id="SignupBannerContainer__OpacityContainer-sc-1ialsxm-0"]{content:"bAHUYV,"}/*!sc*/
.bbVlAa{height:0px;-webkit-transition:height 500ms ease-in-out;transition:height 500ms ease-in-out;}/*!sc*/
data-styled.g154[id="SignupBannerContainer__HeightContainer-sc-1ialsxm-1"]{content:"bbVlAa,"}/*!sc*/
.hgkeGo{background-size:cover;background-position:center;background-image:url('https://assets.production.linktr.ee/profiles/_next/static/images/signup-banner-4f6a179612843b63eece3533261aa931.jpg'),linear-gradient(-40deg,transparent 0%,rgba(0,0,0,0.2) 100%);}/*!sc*/
data-styled.g155[id="SignupBannerOpen__Banner-sc-rdtv4q-0"]{content:"hgkeGo,"}/*!sc*/
.bbAlHz{-webkit-transform:rotate(180deg);-ms-transform:rotate(180deg);transform:rotate(180deg);cursor:pointer;-webkit-transition:-webkit-transform 0.2s 0.2s ease-in-out;-webkit-transition:transform 0.2s 0.2s ease-in-out;transition:transform 0.2s 0.2s ease-in-out;}/*!sc*/
data-styled.g156[id="SignupBannerToggle__Transition-sc-yw5ivp-0"]{content:"bbAlHz,"}/*!sc*/
html,body,div,span,applet,object,iframe,h1,h2,h3,h4,h5,h6,p,blockquote,pre,a,abbr,acronym,address,big,cite,code,del,dfn,em,img,ins,kbd,q,s,samp,small,strike,strong,sub,sup,tt,var,b,u,i,center,dl,dt,dd,ol,ul,li,fieldset,form,label,legend,table,caption,tbody,tfoot,thead,tr,th,td,article,aside,canvas,details,embed,figure,figcaption,footer,header,hgroup,main,menu,nav,output,ruby,section,summary,time,mark,audio,video{margin:0;padding:0;border:0;font-size:100%;font:inherit;vertical-align:baseline;}/*!sc*/
article,aside,details,figcaption,figure,footer,header,hgroup,main,menu,nav,section{display:block;}/*!sc*/
*[hidden]{display:none;}/*!sc*/
body{line-height:1;}/*!sc*/
...
html > *{-webkit-letter-spacing:normal;-moz-letter-spacing:normal;-ms-letter-spacing:normal;letter-spacing:normal;}/*!sc*/
*,*:before,*:after{box-sizing:inherit;}/*!sc*/
data-styled.g168[id="sc-global-koxjWe2"]{content:"sc-global-koxjWe2,"}/*!sc*/
</style>
	</head>
	<body>
		<!-- Google tag (gtag.js) -->
			...
			<div class="sc-bdfBwQ sc-gsTCUz fGhsIW bhdLno">
				<div class="sc-bdfBwQ sc-gsTCUz bcrzgk bhdLno">
					<div class="sc-bdfBwQ LyLIy">
						<div class="sc-bdfBwQ StyledProfileBackground-sc-1uifkkg-0 jbINSs hufEly"/>
